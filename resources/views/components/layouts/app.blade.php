...
<body class="font-sans text-navy-600 antialiased">
    ...
    >
        ...
        <a href="{{ $siteSettings->phoneUrl() }}" aria-label="Call us" class="w-12 h-12 rounded-full bg-gradient-to-br from-navy-600 to-navy-700 shadow-lg shadow-black/15 flex items-center justify-center text-white hover:scale-110 active:scale-95 transition-transform duration-200">
